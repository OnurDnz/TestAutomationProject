...
namespace TestAutomation.Core.Helpers
{
    public class ExtentReportsHelper
    {
        ...
        public ExtentReportsHelper()
        {
            ...
            reporter = new ExtentV3HtmlReporter(@"C:\Users\onurd\source\repos\Simple\Simple\Reports\ExtentReports.html");
        ...
        {
            var printMessage = "<p><b>Test FAILED!</b></p>"; if (!string.IsNullOrEmpty(message))
            {
